      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
        ...
        <div className="hidden xl:flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-white/20 hover:border-accent text-text-secondary hover:text-white text-sm font-semibold transition-colors duration-200"
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-5 py-2 rounded-lg bg-accent hover:bg-accent-hover text-white text-sm font-semibold transition-colors duration-200"
        ...
        >
          ...
          <div className="mt-3 flex flex-col gap-2">
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setMenuOpen(false)}
              className="flex items-center justify-center gap-2 px-5 py-2 rounded-lg border border-white/20 hover:border-accent text-text-secondary hover:text-white text-sm font-semibold transition-colors"
            >
              <svg viewBox="0 0 24 24" width={15} height={15} fill="none" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeLinecap="round" strokeLinejoin="round" />
                <polyline points="14 2 14 8 20 8" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <a
              href="#contact"
              onClick={() => setMenuOpen(false)}
              className="block text-center px-5 py-2 rounded-lg bg-accent hover:bg-accent-hover text-white text-sm font-semibold transition-colors"
            >
              Get in Touch
            </a>
          </div>
